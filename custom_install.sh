...
curl -sSL -k --header "authorization: Bearer <TOKEN>" -X POST https://<CONSOLE_CN>/us-1-111573457/api/v1/scripts/defender.sh  -o defender.sh
...
./defender.sh -z -c "us-east1.cloud.twistlock.com" -d "none"  -m --install-host
